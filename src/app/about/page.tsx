      ...
      <div className="absolute inset-0 flex flex-col justify-start items-center z-10 bg-black/40 min-h-full overflow-y-auto pt-8">
        ...
        >
          ...
          <div className="bg-black/60 backdrop-blur-md rounded-xl p-6 shadow-lg border border-white/10 text-center text-white mb-6">
            <p className="text-lg">
              Hi, I&#39;m Matt — a builder focused on designing and delivering reliable, well-architected software. I work across systems, backend architecture, and developer tooling, with a strong emphasis on clarity, stability, and intentional engineering. Currently, I&#39;m developing PEAK Fantasy & Dev Helper, two products that push me to blend practical problem-solving with long-term technical thinking.
            </p>
          </div>
